...
async def start(bot, message):
  ...
  keyboard = [
    [
      InlineKeyboardButton("Physics Wallah Unlocked", callback_data="pwwp")
    ],
    [
      InlineKeyboardButton("Classplus Unlocked", callback_data="cpwp")
    ],
    [
      InlineKeyboardButton("Appx Unlocked", callback_data="appxwp")
    ]
  ]
  ...
  await message.reply_photo(
    ...
    caption="**Free Bot BY @unlocked_coding @unlocked_devs \nPLEASE👇PRESS👇HERE**",
    quote=True,
